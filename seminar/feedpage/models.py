...
class FeedComment(models.Model):
    ...
    author = models.ForeignKey(User, null=True, on_delete=models.CASCADE)
    like_users = models.ManyToManyField(User, blank=True, related_name="like_feedcomments", through="Like")
    like_count = models.IntegerField(default = 0)

    class Meta:
        ordering = ['-like_count', 'create_at']
...
class Like(models.Model):
    ...
    feedcomment = models.ForeignKey(FeedComment, on_delete=models.CASCADE, null=True)
